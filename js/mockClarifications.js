    ...
    function getDefaultClarifications(taskId) {
        var base = [
            ...
            },
            {
                ...
                messages: [
                    { id: 'msg_v1', role: 'verifier', authorName: 'SGS', content: '核算报告草稿第3章结论表述请与核查声明保持一致。', createdAt: '2026-03-03T09:00:00' }
                ]
            },
            {
                ...
                messages: [
                    { id: 'msg_v2', role: 'verifier', authorName: 'SGS', content: '工序A能耗数据来源需补充凭证或说明，请运营确认后回复或转交供应商。', createdAt: '2026-03-03T10:00:00' }
                ]
            }
        ];
        return base;
